                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" aria-describedby="basic-addon1" name="estado" id="estado">
                                </div>
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" aria-describedby="basic-addon1" name="codigo" id="codigo">
                                </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('estadoEliminar', $estados['id']) }}">Borrar</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('#guardar').click(function(e){
          ...
          url = 'guardaEstado/'+estado+'/'+codigo;
